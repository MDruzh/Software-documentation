...
public class SendDataConsoleImpl implements SendDataService {
    ...
    private final static String CACHE_HOSTNAME = "laboratory4.redis.cache.windows.net";
    private final static String CACHE_KEY = "cJwtTnMHmURaaATeQBtJCnmiZjtX2kKpmu7KFRBF1IE=";
