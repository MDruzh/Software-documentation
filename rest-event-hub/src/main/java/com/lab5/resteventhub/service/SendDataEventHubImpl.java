...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setNamespaceName("laboratory4")//namespace
                .setEventHubName("lab4-eventhub")//hub name
                /*Connection string–primary key*/
                .setSasKeyName("Endpoint=sb://laboratory4.servicebus.windows.net/;SharedAccessKeyName=eventhub_pol;SharedAccessKey=cxcwGXGhtpT+Pc2vvHmyYBu1gTKBnzh2jKKrYaRRev4=;EntityPath=lab4-eventhub")
                /*Primary key*/
                .setSasKey("cxcwGXGhtpT+Pc2vvHmyYBu1gTKBnzh2jKKrYaRRev4=");
